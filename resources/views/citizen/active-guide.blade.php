...
<div class="max-w-4xl mx-auto px-4 py-6 selection:bg-blue-600 selection:text-white font-sans">
    ...
    <section id="guide-wrap" class="relative bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden transition-all duration-300">
        ...
        <div class="relative bg-[#003B93] p-6 sm:p-8 text-white overflow-hidden">
            ...
            <div class="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div class="min-w-0">
                    ...
                    <h2 class="mt-1.5 text-xl sm:text-2xl font-bold tracking-tight">
                    ...
                    <p class="mt-2 text-xs text-white/80 flex items-center gap-1.5">
                        ...
                        <span class="font-mono bg-white/15 text-white px-2 py-0.5 rounded border border-white/10 font-semibold shadow-xs hover:bg-white/25 hover:border-white/30 transition-all duration-150 cursor-default">{{ session('tracking_token') }}</span>
                    </p>
                </div>
        ...
        <div class="p-5 sm:p-8">
                    ...
                    <article data-step-panel="{{ $loop->index }}" class="step-panel hidden transition-opacity duration-200">
                        <div class="grid gap-6 md:grid-cols-12">
                            ...
                            <div class="md:col-span-7 space-y-4">
                                ...
                                <div class="rounded-xl border border-slate-200 bg-white p-4 flex gap-3.5 items-center shadow-2xs hover:border-slate-350 hover:shadow-xs transition-all duration-200">
                                ...
                                <div class="rounded-xl border border-slate-200 bg-white p-4.5 shadow-2xs hover:border-slate-350 hover:shadow-xs transition-all duration-200">
                                ...
                                <button type="button" data-complete-step="{{ $loop->index }}" class="complete-step-btn w-full rounded-xl border border-slate-200 bg-white p-3.5 text-xs font-semibold transition-all duration-150 flex items-center justify-center gap-2.5 cursor-pointer focus:outline-none hover:bg-slate-50 hover:border-blue-600 group/btn">
                            ...
                            <aside class="md:col-span-5 rounded-xl border border-slate-200 bg-slate-50/40 p-4.5 flex flex-col justify-between shadow-2xs hover:border-slate-350 hover:bg-slate-50/70 transition-all duration-200">
                                <div>
            ...
            <footer class="mt-8 pt-5 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
